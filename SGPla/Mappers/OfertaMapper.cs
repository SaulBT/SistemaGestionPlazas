    ...
    public class OfertaMapper
    {
        ...
        public static Oferta ToModel(OfertaDTO dto)
        {
            ...
            return new Oferta
            {
                ...
                Incluida = dto.Incluida && !dto.TieneDocente,
                NumeroPersonalImportado = string.IsNullOrWhiteSpace(dto.NP) ? null : dto.NP.Trim(),
                NombreDocenteImportado = string.IsNullOrWhiteSpace(dto.NombreDocente) ? null : dto.NombreDocente.Trim(),
                Hsm = dto.HorasPago,
